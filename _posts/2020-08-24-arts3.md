...
- Tip：
  ...
  - hosts文件位置：
    - Window系统：`C:\Windows\System32\drivers\etc`，可`Window + R`打开“运行”，黏贴以上地址回车打开或者`vim C:\Windows\System32\drivers\etc\hosts`；
...
- Share：
  ...
  - [12个例子带你入门Electron](https://mp.weixin.qq.com/s/ODs4QMjL1P90F_jXdc82_Q){:target='_blank'}
...
- Share：
  ...
  - [如何从零开始创建React项目（三种方式）](https://www.jianshu.com/p/68e849768d8e){:target='_blank'}
