...
> 资料参考：[浏览器是如何工作的：Chrome V8 让你更懂 JavaScript](https://segmentfault.com/a/1190000037435824){:target='\_blank'}
...
## 第三十一式：position 定位只知道`absolute`、`fixed`、`relative` 和 `static`？，`sticky`其实可以很惊艳
